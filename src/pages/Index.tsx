        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" className="bg-islamic-brown hover:bg-islamic-brown/80 text-black border-0">
                عن المركز
              </Button>
            </div>
          </div>
      ...
      <section className="py-20 bg-islamic-green">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-black border-0">
              تصفح كضيف
            </Button>
          </div>
        </div>
